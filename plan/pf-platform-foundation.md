...
**Status:** Planned / active owner-authorised programme; PF-B1, PF-B2, PF-B3 and PF-B4 are terminal, PF-B5-S01 is terminal and PF-B5-S02 is Ready.
...
PF-B5-S01 is terminally implemented and PF-B5-S02 is the next sequential Slice. Containers, production-data import
...
| PF-B5 | Product catalogue and product access | S01–S02 | S01 **Terminal**; S02 **Ready** |
